...
export const DesignerComponents = isFontLoaded() ? WithConfigSetter(WithSelection(SequenceViewer)) :
  WithFontsLoader(WithConfigSetter(WithSelection(SequenceViewer)));


export const DesignerComponentsViewer = isFontLoaded() ? WithConfigSetter(SequenceViewer) :
